		...
		>
			<div className="w-full max-w-3xl bg-[#050610]/85 rounded-xl shadow-[0_0_30px_rgba(0,0,0,0.7)] border border-red-900/60 p-6 md:p-8 space-y-6">
				<div className="text-center space-y-2">
					...
					<h1 className="text-2xl md:text-3xl font-bold text-red-500 font-sharetech tracking-[0.25em] uppercase">How to Play</h1>
				</div>

				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div className="space-y-3">
						<h2 className="text-sm font-semibold text-red-400 uppercase tracking-[0.2em] font-sharetech">Goal</h2>
						<p className="text-sm text-slate-200">Review each post and decide if it is <span className="text-emerald-400">True</span> or <span className="text-red-400">Fake</span>. Look for visual clues and inconsistencies highlighted by hotspots.</p>

						<h2 className="text-sm font-semibold text-red-400 uppercase tracking-[0.2em] font-sharetech">Controls</h2>
						<ul className="text-sm text-slate-200 space-y-1 list-disc list-inside">
							<li>Swipe right or press Truth to mark as True.</li>
							<li>Swipe left or press Nope to mark as Fake.</li>
							<li>Hover hotspots to see labels describing visual clues.</li>
						</ul>
					</div>

					<div className="space-y-3">
						<h2 className="text-sm font-semibold text-red-400 uppercase tracking-[0.2em] font-sharetech">Tips</h2>
						<ul className="text-sm text-slate-200 space-y-1 list-disc list-inside">
						...
						<h2 className="text-sm font-semibold text-red-400 uppercase tracking-[0.2em] font-sharetech">End of Round</h2>
